...
class Movie(models.Model):
    ...
    actors = models.TextField(verbose_name='Актеры', null=True)
    genres = models.ManyToManyField(Genre, verbose_name='Жанр', null=True)
    ...
    start_time = models.ManyToManyField(Time, verbose_name='Cеансы', null=True)
